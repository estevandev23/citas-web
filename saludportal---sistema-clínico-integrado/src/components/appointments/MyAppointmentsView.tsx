                  ...
                  <div className="mt-4 p-5 bg-[#eff4ff] border border-[#0051d5]/30 rounded-2xl space-y-4 animate-in fade-in duration-150">
                    <div className="flex items-center justify-between border-b border-[#dce9ff] pb-2">
                      ...
                      <button
                        ...
                        className="text-xs text-[#74777e] hover:text-[#001428]"
                      >
                        Cancelar
                      </button>
                    </div>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-3 py-1.5 bg-[#eff4ff] text-[#0051d5] text-xs font-bold rounded-xl hover:bg-[#dce9ff] transition-colors"
                >
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-4 border border-[#dce9ff] shadow-2xl">
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 py-2 text-xs font-semibold text-[#43474d] hover:bg-neutral-100 rounded-xl transition-colors"
              >
                Mantener mi Cita
              </button>
              <button
                onClick={handleConfirmCancellation}
                className="flex-1 py-2 text-xs font-bold text-white bg-red-700 hover:bg-red-800 rounded-xl transition-colors shadow-sm"
              >
