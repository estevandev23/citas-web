...
export const RegisterView: React.FC<RegisterViewProps> = ({ onRegisterSuccess, onNavigate }) => {
  ...
  const [validatedBdua, setValidatedBdua] = useState(true);
  const [firstName, setFirstName] = useState('Carolina');
  const [lastName, setLastName] = useState('Morales');
  const [phone, setPhone] = useState('312 849 4920');
      ...
      {isSuccess ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <form onSubmit={handleSubmit} className="lg:col-span-8 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#f8f9ff] border border-[#dce9ff] rounded-xl px-3 py-2 text-xs font-bold"
                  >
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full bg-[#f8f9ff] border border-[#dce9ff] rounded-xl px-3 py-2 text-xs font-mono font-bold"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#f8f9ff] border border-[#dce9ff] rounded-xl px-3 py-2 text-xs"
                  />
                </div>
                <div>
                  <label className="block text-[11px] font-bold text-[#74777e] uppercase mb-1">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#f8f9ff] border border-[#dce9ff] rounded-xl pl-9 pr-3 py-2 text-xs font-mono"
                  />
            ...
            <button
              type="submit"
              disabled={!isPasswordValid || !termsAccepted || !sgsssAccepted}
              className={`w-full py-3.5 rounded-xl text-xs font-bold shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer ${
                isPasswordValid && termsAccepted && sgsssAccepted
