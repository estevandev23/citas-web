            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#f8f9ff] border border-[#dce9ff] rounded-xl px-3 py-2.5 text-xs font-bold"
                >
              ...
              <div className="col-span-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#f8f9ff] border border-[#dce9ff] rounded-xl pl-9 pr-3 py-2.5 text-xs font-mono font-bold"
                  />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#f8f9ff] border border-[#dce9ff] rounded-xl pl-9 pr-3 py-2.5 text-xs"
                />
        ...
        {subStep === 'sent' && (
          <div className="space-y-5 text-center py-2 animate-in zoom-in-95 duration-150">
            ...
            <div className="flex flex-col gap-2 pt-2">
              ...
              <button
                onClick={() => setSubStep('request')}
                className="text-xs font-semibold text-[#74777e] hover:text-[#001428]"
              >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-2.5 text-[#74777e] hover:text-[#001428]"
                >
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-150">
          <div className="bg-white rounded-3xl max-w-sm w-full p-8 text-center space-y-4 shadow-2xl border border-emerald-200">
            ...
            <button
              onClick={() => onNavigate('login')}
              className="w-full py-2.5 bg-[#0051d5] text-white text-xs font-bold rounded-xl hover:bg-[#003ea8] transition-colors"
            >
