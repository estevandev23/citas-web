      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] flex flex-col shadow-2xl overflow-hidden border border-[#dce9ff]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#e5eeff] bg-[#f8f9ff]">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="p-2 text-[#43474d] hover:bg-[#eff4ff] hover:text-[#0051d5] rounded-lg transition-colors"
              title="Imprimir"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 bg-[#0051d5] text-white text-xs font-semibold rounded-lg hover:bg-[#003ea8] transition-colors"
            >
            ...
            <button
              onClick={onClose}
              className="p-2 text-[#74777e] hover:bg-neutral-100 rounded-lg transition-colors ml-2"
              aria-label="Cerrar"
            >
              <X className="w-5 h-5" />
            </button>
